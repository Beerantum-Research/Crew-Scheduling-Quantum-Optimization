...
| File | Description |
|------|-------------|
| `ttn_fraction_comparison.xlsx` | Cross-fraction summary table comparing key metrics (cost, variable reduction, solve time) across all 9 TTN fractions side by side |
